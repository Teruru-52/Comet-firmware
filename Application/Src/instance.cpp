...
undercarriage::DynamicFeedback dynamic_feedback(1.0, 0.05, 1.0, 0.05, control_period);

undercarriage::TrackingBase *tracking_controller{&kanayama};
// undercarriage::TrackingBase *tracking_controller{&dynamic_feedback};
...
trajectory::Acceleration acc(parameters_start1, parameters_forward1, parameters_stop1);
